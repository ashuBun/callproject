...
export async function generateMetadata({
  ...
  let pageUrl = `${SITE_URL}/sexcams`;
  if (pathname && pathname !== "/") {
    pageUrl = `${SITE_URL}${pathname}`;
  } else {
    pageUrl = locale === "en" ? `${SITE_URL}/sexcams` : `${SITE_URL}/${locale}/sexcams`;
  }
  ...
  const ogImageUrl = getTopSiteImageUrl("sexcam", IMAGE_URL);
