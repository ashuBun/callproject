...
export async function generateMetadata({
  ...
  let pageUrl = `${SITE_URL}/fetishchat`;
  if (pathname && pathname !== "/") {
    pageUrl = `${SITE_URL}${pathname}`;
  } else {
    pageUrl = locale === "en" ? `${SITE_URL}/fetishchat` : `${SITE_URL}/${locale}/fetishchat`;
  }
  ...
  const ogImageUrl = getTopSiteImageUrl("fetish", IMAGE_URL);
