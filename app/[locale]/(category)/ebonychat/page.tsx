...
export async function generateMetadata({
  ...
  let pageUrl = `${SITE_URL}/ebonychat`;
  if (pathname && pathname !== "/") {
    pageUrl = `${SITE_URL}${pathname}`;
  } else {
    pageUrl = locale === "en" ? `${SITE_URL}/ebonychat` : `${SITE_URL}/${locale}/ebonychat`;
  }
  ...
  const ogImageUrl = getTopSiteImageUrl("ebony", IMAGE_URL);
